...
LetiFramework.Ui.storyTitle.prototype = {
    ...
    create: function() {
        ...
        if (titleArea.custom_font) {
            ...
            title = this.game.add.bitmapText(this.game.world.centerX, panel2Height / 2 + panel2.y, cf.font,
                LetiFramework.Utils.wrapText(this.currentGame.name, cf.wordWrapWidth, cf.font, cf.font_size), cf.font_size);
        } else {
        ...
        if (contentArea.custom_font) {
            ...
            var infoText = this.game.add.bitmapText(this.game.world.centerX + 0.25 * panel1Width, panel1Height * 0.20 + panel1.y,
                cf.font, LetiFramework.Utils.wrapText(this.currentGame.description, cf.wordWrapWidth, cf.font, cf.font_size), cf.font_size);
        ...
        if (progressText.custom_font) {
            ...
            this.preloadText = this.game.add.bitmapText(progressText.position.x, progressText.position.y,
                cf.font, "Downloading Content...", cf.font_size);
        } else {
    ...
    createModals: function() {
        ...
        this.modals.createModal({
            ...
            itemsArr: [{
                    type: "image",
                    content: this.confirmDialog.background,
