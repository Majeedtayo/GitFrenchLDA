...
LetiFramework.Ui.menu.prototype = {
    ...
    preload: function() {
        ...
        this.game.load.image(this.screenConfig.share_button.image, this.getScreenConfigImagePath(this.screenConfig.share_button.image));
        ...
        this.game.load.image(settingsDropDown.edit_password_button.image, this.getScreenConfigImagePath(settingsDropDown.edit_password_button.image));
        this.game.load.image(shareDropDown.facebook_button.image, this.getScreenConfigImagePath(shareDropDown.facebook_button.image));
        this.game.load.image(shareDropDown.twitter_button.image, this.getScreenConfigImagePath(shareDropDown.twitter_button.image));
    ...
    create: function() {
        ...
        if (earnedCount > 0) {
            ...
            if (this.screenConfig.badge.custom_font) {
                this.badgeCount = this.game.add.bitmapText(badgePos.x + 0.5 * this.badgeBt.width,
                    badgePos.y + 0.5 * this.badgeBt.height, this.screenConfig.badge.custom_font.font,
        ...
        this.fbBt = this.game.add.button(shareBtPosition.x, shareBtPosition.y, shareDropDown.facebook_button.image, function() {
        ...
        this.twBt = this.game.add.button(shareBtPosition.x, shareBtPosition.y, shareDropDown.twitter_button.image, function() {
        ...
        this.editPasswordBt = this.game.add.button(settingsBtPosition.x, settingsBtPosition.y, settingsDropDown.edit_password_button.image,
            function() {
        ...
        this.shareBt = this.game.add.button(shareBtPosition.x, shareBtPosition.y, this.screenConfig.share_button.image, function() {
