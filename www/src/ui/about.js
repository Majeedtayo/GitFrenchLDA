...
LetiFramework.Ui.about.prototype = {
    ...
    create: function() {
        ...
        if (customFont) {
            var text = LetiFramework.Utils.wrapText(titleArea.text, customFont.wordWrapWidth,
                customFont.font, customFont.font_size);
            var title = this.game.add.bitmapText(this.game.world.centerX, panel2Height / 2 + panel2.y,
                customFont.font, text, customFont.font_size);
        ...
        if (customFont) {
            var text = LetiFramework.Utils.wrapText(contentArea.text, customFont.wordWrapWidth,
                customFont.font, customFont.font_size);
