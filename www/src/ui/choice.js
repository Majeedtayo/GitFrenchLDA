...
LetiFramework.Ui.choice.prototype = {
    ...
    preload: function() {
        ...
        for (var i = 0; i < this.choices.length; i++) {
            ...
            if (choice.custom_font) {
                LetiFramework.Utils.loadAssetFont(choice.custom_font);
            }
        }
    ...
    create: function() {
        ...
        if (this.currentGamePageData.custom_font) {
            ...
            this.titleText = this.game.add.bitmapText(this.titleTextBg.x + this.titleTextBg.width / 2,
                this.titleTextBg.y + this.titleTextBg.height / 2, cf.font,
                LetiFramework.Utils.wrapText(this.currentGamePageData.text, cf.wordWrapWidth, cf.font, cf.font_size),
                cf.font_size);
        } else {
        ...
        for (var i = 0; i < this.choices.length; i++) {
            ...
            choiceSprite.scale.setTo(choice.width ? choice.width / choiceSprite.width : 1, choice.height ? choice.height / choiceSprite.height : 1);
            ...
            if (choice.text.length > 0) {
                ...
                if (choice.custom_font) {
                    var cf = choice.custom_font;
                    this.choiceText = this.game.add.bitmapText(
                        choiceTextBg.x + choiceTextBg.width / 2, choiceTextBg.y + choiceTextBg.height / 2,
                        cf.font, LetiFramework.Utils.wrapText(choice.text, cf.wordWrapWidth, cf.font, cf.font_size), cf.font_size);
                } else {
                    this.choiceText = this.game.add.text(
                        choiceTextBg.x + choiceTextBg.width / 2, choiceTextBg.y + choiceTextBg.height / 2,
                        choice.text, choice.text_style);
                }
