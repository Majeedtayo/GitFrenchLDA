		...
		if (this.narrations.length > 0) {
			...
			if (this.currentGamePageData.custom_font) {
				...
				this.narrText = this.game.add.bitmapText(this.narrTextBg.x + this.narrTextBg.width / 2, this.narrTextBg.y + this.narrTextBg.height / 2,
					cf.font, LetiFramework.Utils.wrapText(this.narrations[this.narrationIdx], cf.wordWrapWidth, cf.font, cf.font_size), cf.font_size);
			} else {
				this.narrText = this.game.add.text(this.narrTextBg.x + this.narrTextBg.width / 2, this.narrTextBg.y + this.narrTextBg.height / 2,
					this.narrations[this.narrationIdx], this.currentGamePageData.text_style);
			}
