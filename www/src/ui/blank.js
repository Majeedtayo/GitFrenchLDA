...
LetiFramework.Ui.blank = function(game) {}

LetiFramework.Ui.blank.prototype = {
    init: function() {
        LetiFramework.Analytics.trackPage("Blank");

        this.screenConfig = LetiFramework.GameController.screensConfig.blank;
        ...
        if (this.currentGamePageData.points) {
            ...
            if (rs.length == 0) {
                ...
                LetiFramework.Analytics.trackEvent("Blank", "Points Score", log, 0);
        ...
        if (this.badge) {
            ...
            if (!alreadyEarnedBadge && awardBadge) {
                ...
                if (rs.length > 0) {
                    ...
                    LetiFramework.Analytics.trackEvent("Blank", "Badge Earned", {
                        "story": this.currentGame.name,
                        "page": this.currentGamePage,
                        "badge": badge
                    }, 0);
    ...
    create: function() {
        ...
        this.homeBt = this.game.add.button(optionsBtPosition.x, optionsBtPosition.y, optionsDropDown.home_button.image,
            function() {
                LetiFramework.Analytics.trackEvent("Blank", "Button Click", "Home", 0);
        ...
        this.soundBt = this.game.add.button(optionsBtPosition.x, optionsBtPosition.y,
            ...
            function() {
                ...
                if (LetiFramework.SoundManager.narrationOn) {
                    LetiFramework.Analytics.trackEvent("Blank", "Button Click", "Sound On", 0);
                    this.soundBt.loadTexture(this.screenConfig.options_button.children.sound_button.on_image);
                } else {
                    LetiFramework.Analytics.trackEvent("Blank", "Button Click", "Sound Off", 0);
        ...
        this.musicBt = this.game.add.button(optionsBtPosition.x, optionsBtPosition.y,
            ...
            function() {
                ...
                if (LetiFramework.SoundManager.soundOn) {
                    LetiFramework.Analytics.trackEvent("Blank", "Button Click", "Music On", 0);
                    ...
                    LetiFramework.Analytics.trackEvent("Blank", "Button Click", "Music Off", 0);
        ...
        this.optionsBt = this.game.add.button(optionsBtPosition.x, optionsBtPosition.y, optionsBt.image,
            function() {
                LetiFramework.Analytics.trackEvent("Blank", "Button Click", "Options", 0);
        ...
        this.prevBt = this.game.add.button(prevBtPosition.x, prevBtPosition.y, this.screenConfig.prev_button.image,
            function() {
                LetiFramework.Analytics.trackEvent("Blank", "Button Click", "Previous Page", 0);
        ...
        if (this.currentGamePageData.transition.transition_type == "auto") {
            ...
            this.nextBt = this.game.add.button(nextBtPosition.x, nextBtPosition.y, this.screenConfig.next_button.image,
                function() {
                    LetiFramework.Analytics.trackEvent("Blank", "Button Click", "Next Page", 0);
                    LetiFramework.GameController.nextPage();
                }, this, 2, 1, 0);
            ...
            if (asset.type == "shape") {
                ...
                if (asset.start == "auto") {
                    ...
                    cmp.events.onInputDown.add(function(src) {
                        ...
                        LetiFramework.Analytics.trackEvent("Blank", "Interactivity", log, 0);
