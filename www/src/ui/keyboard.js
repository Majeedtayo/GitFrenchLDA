...
LetiFramework.Ui.keyboard.prototype = {
	...
	create: function() {
		...
		for (var i = 1, x = startX, y = startY; i < 11; i++, x += 93) {
			...
			var button = new LetiFramework.Ui.RoundButton(this.game, x, y, 80, 80, 30, 
		...
		for (var i = 0, x = startX, y = startY; i < alphabets.length && !this.isNumber; i++, x += 93) {
			if(i + 1 == alphabets.length) {
				var button = new LetiFramework.Ui.RoundButton(this.game, x, y, 173, 80, 30, 
				...
				button = new LetiFramework.Ui.RoundButton(this.game, x + 186, y, 266, 80, 30, 
		        	"Space", style[0], style[1], function() { 
		        		LetiFramework.Renderer.currentState().appendInputText(" ");
		        	}, null);
				button = new LetiFramework.Ui.RoundButton(this.game, this.game.width - 207, y, 173, 80, 30, 
		...
		for (var i = 0; i < fxns.length; i++, startY += 68) {
			var button = new LetiFramework.Ui.RoundButton(this.game, startX, startY, 266, 60, 30,
